      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Participate in live auctions, bid on exceptional artworks, and
            support emerging artists worldwide
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => setCurrentPage("artworks")}
              className="px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-gray-900 rounded-lg font-bold hover:shadow-2xl hover:shadow-amber-500/50 transition-all duration-300"
            >
              Explore Auctions
            </button>

            {/* ✅ Fixed: Navigates correctly to /login */}
            <button
              onClick={() => navigate("/login")}
              className="px-8 py-3 border-2 border-amber-500 text-amber-400 rounded-lg font-bold hover:bg-amber-500/10 transition-all duration-300"
            >
              Get Started
            </button>
          </div>
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-amber-500/50 transition-all group"
              >
